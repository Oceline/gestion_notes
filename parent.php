...
<body>
 ...
 <div class=" col-md-6 col-sm-6 col-lg-6 ms-3">
 <button type="submit" class="btn btn-outline-success bg-black text-white acceder rounded-0">Accéder aux informations de l'élève</button>       
 </div>
 </section>
</main>
<footer>
